...
import { CalculatorIcon, BookText, CheckCircle2, Scale, Shapes } from "lucide-react";
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader>
        ...
        <CardDescription>
          Des outils simples pour les premiers pas en mathématiques, incluant un solveur de problèmes par IA.
        </CardDescription>
      </CardHeader>
